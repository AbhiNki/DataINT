...
public class AllQueryOperation 
{
	...
	public void performQueryOp(String filePath, String workingDir, String flag) throws SQLException, IOException
	{
		System.out.println("Running all intermediated database query and operations.....");
		 ...
		 tc.transitiveClosure(con, workingDir);
	     ...
	     try
	     {
	    	 ...
	    	 p.waitFor();
	    	 q=Runtime.getRuntime().exec("hadoop fs -copyFromLocal "+workingDir+"/IndexFiles/TCOUTPUT /user/cloudera/HiveDataFolder");
